...
class _CustomCountryCodePickerState extends State<CustomCountryCodePicker> {
      ...
      builder: (context, state) {
        return Scaffold(
          ...
          floatingActionButton:
              DialogWidget(phone: phone, choosenCountry: choosenCountry),
        );
      },
    );
  }
                  ...
                  setState(() {
                    ...
                    phoneController.value = TextEditingValue(
                      ...
                      selection: TextSelection.collapsed(
                        offset: formatPhoneNumber(value)!.length,
                      ),
                    );
                  });
                }),
  ...
  Future<dynamic> showBottomModalSheet(BuildContext context) {
              ...
              children: [
                ...
                TextField(
                  decoration: InputDecoration(
                    ...
                    filled: true,
                    fillColor: const Color.fromRGBO(244, 255, 255, 0.4),
                  ),
                  onChanged: (value) {
                    context
                        .read<DatabaseBloc>()
                ...
                Expanded(
                  child: BlocBuilder<DatabaseBloc, DatabaseState>(
                        ...
                        itemBuilder: (context, index) {
                          return ListTile(
                            onTap: () {
                              ...
                              setState(() {
                                choosenImage = state.countries[index].flagUrl;
                                choosenDial = state.countries[index].dialCode;
                                choosenCountry = state.countries[index].name;
                              });
                            },
                            title: RichText(
                              text: TextSpan(
                                text: '+${state.countries[index].dialCode}  ',
                                style: const TextStyle(
                                    fontSize: 16,
                    ...
                    } else if (state.state == SearchState.search) {
                      return ListView.builder(
                          ...
                          return ListTile(
                            ...
                            title: RichText(
                              text: TextSpan(
                                ...
                                children: <TextSpan>[
                                  TextSpan(
                                    text: state.searchedCountries[index].name,
                                    style: const TextStyle(
                                        fontWeight: FontWeight.w500,
                                        fontSize: 16,
                                        color: Colors.white),
                            ...
                            leading: Image.network(
                              state.searchedCountries[index].flagUrl,
                              width: 20,
                              height: 20,
                            ),
                          );
